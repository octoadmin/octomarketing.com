...
DROP TABLE IF EXISTS `octo_et_social_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `octo_et_social_stats` (
...
LOCK TABLES `octo_et_social_stats` WRITE;
/*!40000 ALTER TABLE `octo_et_social_stats` DISABLE KEYS */;
/*!40000 ALTER TABLE `octo_et_social_stats` ENABLE KEYS */;
UNLOCK TABLES;
