...
class ameWidgetEditor {
	...
	public function __construct($menuEditor) {
		...
		$exportAction = new ameAjaxAction('ws-ame-export-widgets');
		$exportAction
			->setRequiredParams('widgetData')
			->setAuthCallback(array($this, 'userCanEditWidgets'))
			->setHandler(array($this, 'ajaxExportWidgets'));

		$importAction = new ameAjaxAction('ws-ame-import-widgets');
		$importAction
			->setAuthCallback(array($this, 'userCanEditWidgets'))
			->setHandler(array($this, 'ajaxImportWidgets'));
	}
